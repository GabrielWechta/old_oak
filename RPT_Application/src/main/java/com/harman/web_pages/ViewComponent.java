...
public class ViewComponent extends VerticalLayout {
	...
	private static final long serialVersionUID = -240270533438413029L;
	...
	public ViewComponent(@Autowired Greeter greeter) {
		...
		Image twinPeaksImage = new Image(
				"https://pmcvariety.files.wordpress.com/2014/10/twin-peaks-returning-to-tv.jpg?w=1000&h=563&crop=1",
				"Cooper's Dream");
